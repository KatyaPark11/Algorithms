namespace Algorithms
{
    ...
    public static class RadixSort
    {
        ...
        {
            // Устанавливаем длину первого элемента массива в качестве будущей максимальной длины.
            int maxLen = array[0].Length;
            // Пробегаемся по массиву n - 1 раз, где n - длина массива.
            for (int i = 1; i < array.Length; i++)
                // Сравниваем длину текущего элемента массива и текущую максимальную длину.
                if (array[i].Length > maxLen)
                    // Если длина текущего элемента больше текущей максимальной, то меняем на неё значение максимальной длины.
